<template>
  <div class="app-container">
    ...
    <!--表格渲染-->
    <el-table v-loading="loading" border :data="newdata" :tree-props="{children: 'children', hasChildren: 'hasChildren'}"
     lazy :load="load" :default-expand-all="expand" row-key="id" size="small">
