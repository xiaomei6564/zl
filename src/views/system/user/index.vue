    ...
    <el-row :gutter="20">
      ...
      <el-col :xs="9" :sm="6" :md="4" :lg="4" :xl="4">
        <div class="head-container">
          <el-input v-model="deptName" clearable placeholder="输入业务单位名称搜索" prefix-icon="el-icon-search" style="width: 100%;" class="filter-item" @input="getDeptDatas"/>
        </div>
        <el-tree :data="depts" :props="defaultProps" :default-expanded-keys="[-1]" :expand-on-click-node="false" @node-click="handleNodeClick"/>
      </el-col>
      <!--用户数据-->
      <el-col :xs="15" :sm="18" :md="20" :lg="20" :xl="20">
        ...
        <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
          ...
          <el-table-column label="部门 / 岗位" :show-overflow-tooltip="true">
...
export default {
  ...
  methods: {
    ...
    edit(data) {
      ...
      _this.getDepts()
      _this.roleIds = []
      _this.form = { id: data.id, nickname: data.nickname, username: data.username, phone: data.phone, email: data.email, enabled: data.enabled.toString(), roles: [], dept: { id: data.dept.id }, job: { id: data.job.id }}
