      ...
      <el-col :xs="24" :sm="24" :md="16" :lg="16" :xl="17" style="margin-bottom: 10px">
        <el-card class="box-card" shadow="never">
          <div slot="header" class="clearfix">
            <span class="role-span">角色与数据授权</span>
          </div>
          <el-table v-loading="loading" :data="data" highlight-current-row size="small" style="width: 100%;" @current-change="handleCurrentChange">
            ...
            <el-table-column prop="permission" label="技术标识"/>
            <el-table-column prop="dataScope" label="组织架构"/>
            <el-table-column prop="dataScope" label="产品线" />
        ...
        <el-card class="box-card" shadow="never">
          <div slot="header" class="clearfix">
            <el-tooltip class="item" effect="dark" content="选择指定角色分配菜单" placement="top">
              <span class="role-span">菜单与功能授权</span>
            </el-tooltip>
            <el-button
...
export default {
  ...
  methods: {
    ...
    edit(data) {
      ...
      _this.deptIds = []
      _this.form = { id: data.id, name: data.name, remark: data.remark, depts: data.depts, dataScope: data.dataScope, level: data.level, permission: data.permission,materialGroups:data.materialGroups }
      ...
      for (let i = 0; i < _this.form.materialGroups.length; i++) {
        _this.materialGroups[i] = _this.form.materialGroups[i].id
      }
      console.log(_this.materialGroups)
      _this.dialog = true
    },
    download() {
      this.beforeInit()
